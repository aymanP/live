    ...
    $areas = array(
        'admin' => array(
            array(
                ...
                'id'=>'admin-menu',
                'target' => '.admin #side-menu,.admin #customize-sidebar',
                'css' => 'background',
                'additional_selectors' => 'body|background'
            ),
            array(
                'name' => 'Sidebar Menu/Setup Menu Submenu Open Background Color',
                'id'=>'admin-menu-submenu-open',
                'target' => '.admin #side-menu li .nav-second-level li,.admin #customize-sidebar li .nav-second-level li',
                'css' => 'background',
                'additional_selectors' => ''
            ),
            array(
                'name' => 'Sidebar Menu/Setup Menu Border Bottom',
                'id'=>'admin-menu-border-bottom',
                'target' => '.admin #side-menu li,.admin #customize-sidebar li',
            ...
            array(
                ...
                'id'=>'admin-menu-links',
                'target' => '.admin #side-menu li a,.admin #customize-sidebar li a',
                'css' => 'color',
                'additional_selectors' => ''
            ),
            array(
                ...
                'target' => '.admin #side-menu li.active > a,.admin #customize-sidebar li.active > a',
                'css' => 'background',
                'additional_selectors' => ''
            ),
             array(
                ...
                'target' => '.admin #side-menu li .nav-second-level li.active a,.admin #customize-sidebar li .nav-second-level li.active a',
                'css' => 'background',
                'additional_selectors' => ''
            ),
            array(
                ...
                'target' => '.admin #side-menu li .nav-second-level li a,#customize-sidebar li .nav-second-level li a',
                'css' => 'color',
                'additional_selectors' => ''
            ),
            array(
                'name' => 'Sidebar Menu/Setup Menu First Menu Item Background (welcome user and close setup menu)',
                'id'=>'admin-menu-first-item',
                'target' => '.admin #side-menu li:first-child,#customize-sidebar li:first-child',
                'css' => 'background',
                'additional_selectors' => ''
            ),
            array(
        ...
        'general' => array(
            ...
            array(
                ...
                'css' => 'color',
                'additional_selectors' => '',
                'example'=>'<table class="table dataTable"><thead><tr><th class="sorting">Example Heading 1</th><th class="sorting">Example Heading 2</th></tr></thead></table>',
            ),
            array(
                ...
                'css' => 'background',
                'additional_selectors' => '',
                'example'=>'<table class="table items"><thead><tr><th style="text-align:left;">Example Heading 1</th><th style="text-align:left;">Example Heading 2</th></tr></thead></table>',
            ),
            array(
