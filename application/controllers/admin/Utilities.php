...
class Utilities extends Admin_controller
{
    ...
    public function home_slider(){
        ...
        $data['sliders']   = $this->utilities_model->get_all_sliders();
        $this->load->view('admin/utilities/home_slider', $data);
    }

    public function upload_slider($id)
    {
        handle_slider_upload($id);
    }

    public function delete_slider($id)
    {
        $this->utilities_model->delete_slider($id);
