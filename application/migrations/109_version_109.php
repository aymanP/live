...
class Migration_Version_109 extends CI_Migration
{
  ...
  public function up()
  {
    ...
    if (!is_dir(CLIENT_PROFILE_IMAGES_FOLDER)) {
      mkdir(CLIENT_PROFILE_IMAGES_FOLDER);
      fopen(CLIENT_PROFILE_IMAGES_FOLDER . 'index.html', 'w');
      $fp = fopen(CLIENT_PROFILE_IMAGES_FOLDER . 'index.html', 'a+');
      if ($fp) {
        fclose($fp);
      }
    }
