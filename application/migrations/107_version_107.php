...
class Migration_Version_107 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if (file_exists(MEDIA_FOLDER)) {
            if (!file_exists(MEDIA_FOLDER . 'index.html')) {
                fopen(MEDIA_FOLDER . 'index.html', 'w');
            }
        }
        ...
        if (file_exists(APPPATH . 'views/admin/knowledge_base/group.php')) {
            @unlink(APPPATH . 'views/admin/knowledge_base/group.php');
        }
        ...
        if (file_exists(APPPATH . 'views/admin/leads/status.php')) {
            @unlink(APPPATH . 'views/admin/leads/status.php');
        }
