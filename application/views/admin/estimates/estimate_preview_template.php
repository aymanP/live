        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="pull-right _buttons">
                        <a href="<?php echo admin_url('estimates/estimate/'.$estimate->id); ?>" class="btn btn-default btn-with-tooltip mright5 pull-left" data-toggle="tooltip" title="<?php echo _l('edit_estimate_tooltip'); ?>" data-placement="bottom"><i class="fa fa-pencil-square-o"></i></a>
                        <a href="<?php echo admin_url('estimates/pdf/'.$estimate->id.'?print=true'); ?>" target="_blank" class="btn pull-left btn-default mright5 btn-with-tooltip" data-toggle="tooltip" title="<?php echo _l('print'); ?>" data-placement="bottom"><i class="fa fa-print"></i></a>
                        <a href="<?php echo admin_url('estimates/pdf/'.$estimate->id); ?>" class="btn btn-default btn-with-tooltip pull-left mright5" data-toggle="tooltip" title="<?php echo _l('view_pdf'); ?>" data-placement="bottom"><i class="fa fa-file-pdf-o"></i></a>
                        <?php
                            ...
                            ?>
                        <a href="#" class="estimate-send-to-client btn btn-default mright5 pull-left btn-with-tooltip" data-toggle="tooltip" title="<?php echo $_tooltip; ?>" data-placement="bottom"><i class="fa fa-envelope"></i></a>
                        <div class="btn-group">
            ...
            <div class="tab-content">
                                ...
                                <div class="mbot15 row col-md-12" data-attachment-id="<?php echo $attachment['id']; ?>">
                                    ...
                                    <div class="col-md-4 text-right">
                                        <?php if($attachment['visible_to_customer'] == 0){
                                            ...
                                            ?>
                                        <a href="#" data-toggle="tooltip" onclick="toggle_sales_attachment_visibility(<?php echo $attachment['id']; ?>,<?php echo $estimate->id; ?>,this); return false;" data-title="<?php echo $tooltip; ?>"><i class="<?php echo $icon; ?>" aria-hidden="true"></i></a>
                ...
                <div role="tabpanel" class="tab-pane" id="tab_reminders">
                    <a href="#" data-toggle="modal" data-target=".reminder-modal"><i class="fa fa-bell-o"></i> <?php echo _l('estimate_set_reminder_title'); ?></a>
                    <hr />
                ...
                <div role="tabpanel" class="tab-pane" id="tab_notes">
                    ...
                    <?php echo _l('estimate_add_note'); ?></button>
