                       ...
                       if(($max_input>0 && isset($total_rows_post) && $total_rows_post >= $max_input)){ ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <?php echo render_select('source',$sources,array('id','name'),'lead_import_source',get_option('leads_default_source')); ?>
                                <?php echo render_select('status',$statuses,array('id','name'),'lead_import_status',get_option('leads_default_status')); ?>
