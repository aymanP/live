...
<!-- Copy Project -->
<div class="modal fade" id="pre_estimate_project_settings" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <?php echo _l('estimate_project_info'); ?>
                </h4>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="radio radio-primary">
                                        <input type="radio" <?php if($billing_type == 3){echo 'disabled';}else{echo 'checked';}?> name="estimate_data_type" value="single_line" id="single_line">
                                        <label for="single_line"><?php echo _l('estimate_project_data_single_line'); ?></label>
                                    </div>
                                </div>
