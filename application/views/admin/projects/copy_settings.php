            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="checkbox checkbox-primary">
                            <input type="checkbox" name="discussions" id="c_discussions">
                            <label for="c_discussions"><?php echo _l('project_discussions'); ?> <small><?php echo _l('copy_project_discussions_not_included'); ?></small>
                            </label>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
