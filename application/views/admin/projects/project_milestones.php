        ...
        <div class="col-md-3 mtop25 milestone-column" data-milestone-id="<?php echo $milestone['id']; ?>">
            <div class="panel-heading panel-heading-bg <?php if($milestone_color != ''){echo 'color-not-auto-adjusted color-white ';} ?><?php if($milestone['id'] != 0){echo 'task-phase';}else{echo 'info-bg';} ?>"<?php echo $milestone_color; ?>>
                <?php if($milestone['id'] != 0 && has_permission('projects','','edit')){ ?>
                  <a href="#" data-name="<?php echo $milestone['name']; ?>" data-due_date="<?php echo _d($milestone['due_date']); ?>" data-order="<?php echo $milestone['milestone_order']; ?>" onclick="edit_milestone(this,<?php echo $milestone['id']; ?>); return false;" class="edit-milestone-phase <?php if($milestone['color'] != ''){echo 'color-white';} ?>">
                <?php } ?>
...
<div id="milestones-table" class="hide">
