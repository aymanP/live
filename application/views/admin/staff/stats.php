     ...
     <div class="panel_s">
      <div class="panel-body">
       <h3 class="text-muted _total">
         <?php echo format_seconds($logged_time['total']); ?>
       </h3>
 ...
 <div class="<?php echo $column; ?> col-sm-6 col-xs-12 total-column">
   <div class="panel_s">
    <div class="panel-body">
     <h3 class="text-muted _total">
       <?php echo format_seconds($logged_time['last_month']); ?>
     </h3>
...
<div class="<?php echo $column; ?> col-sm-6 col-xs-12 total-column">
 <div class="panel_s">
  <div class="panel-body">
   <h3 class="text-muted _total">
    <?php echo format_seconds($logged_time['this_month']); ?>
  </h3>
...
<div class="<?php echo $column; ?> col-sm-6 col-xs-12 total-column">
 <div class="panel_s">
  <div class="panel-body">
   <h3 class="text-muted _total">
     <?php echo format_seconds($logged_time['last_week']); ?>
   </h3>
...
<div class="<?php echo $column; ?> col-sm-6 col-xs-12 total-column">
 <div class="panel_s">
  <div class="panel-body">
   <h3 class="text-muted _total">
     <?php echo format_seconds($logged_time['this_week']); ?>
   </h3>
