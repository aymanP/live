                                  ...
                                  <div class="media-body">
                                    ...
                                    if(($notification['fromcompany'] == NULL && $notification['fromuserid'] != 0) || ($notification['fromcompany'] == NULL && $notification['fromclientid'] != 0)){
                                     if($notification['fromuserid'] != 0){
                                      ...
                                      $description = get_contact_full_name($notification['fromclientid']). ' - ' . $description . '<br /><span class="label inline-block mtop5 label-info">'._l('is_customer_indicator').'</span>';
                                    }
                                  }
                                  echo $description; ?><br />
