...
//}
//
////array_push($where,array('tblinvoices.supplierid !='=> 0));
//
...
//
//                if (is_numeric($supplierid)) {
//                    $__data = '<a href="' . admin_url('supplier_invoices/list_invoice/' . $aRow['id']) . '" target="_blank">' . format_invoice_number($aRow['id']) . '</a><br />';
//                } else {
...
//
//               $__data = '<a href="' . admin_url('suppliers/supplier/' . $aRow['supplierid']) . '">'.$aRow['supplierid'].$aRow['tblsuppliers.company'].'</a><br />';
//
//
