...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <?php echo form_open('admin/suppliers/supplier_contact/'.$supplier_id.'/'.$contactid,array('id'=>'contact-form')); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php if(isset($contact)){ ?>
                            <img src="<?php echo supplier_contact_profile_image_url($contact->id,'thumb'); ?>" class="client-profile-image-thumb">
                            <hr />
                        <?php } ?>
                        <!-- // For email exist check -->
                        <?php echo form_hidden('id',$contactid); ?>
                        ...
                        <?php echo render_custom_fields( 'supplier_contacts',$rel_id); ?>
                        ...
                        <div class="checkbox checkbox-primary">
                            <input type="checkbox" name="is_primary" id="contact_primary" <?php if((!isset($contact) && total_rows('tblsuppliercontacts',array('is_primary'=>1,'supplierid'=>$supplier_id)) == 0) || (isset($contact) && $contact->is_primary == 1)){echo 'checked';}; ?> <?php if((isset($contact) && total_rows('tblsuppliercontacts',array('is_primary'=>1,'supplierid'=>$supplier_id)) == 1 && $contact->is_primary == 1)){echo 'disabled';} ?>>
                        ...
                        <?php if(!isset($contact)){ ?>
                            <div class="checkbox checkbox-primary">
                                ...
                                <label for="donotsendwelcomeemail">
                                    <?php echo _l( 'supplier_do_not_send_welcome_email'); ?>
                                </label>
                            </div>
                        <?php } ?>
                        ...
                        <div class="checkbox checkbox-primary">
                            ...
                            <label for="send_set_password_email">
                                <?php echo _l( 'supplier_send_set_password_email'); ?>
                            </label>
                        </div>

                        <div class="checkbox checkbox-primary">
                            <input type="checkbox" name="email_cc" id="email_cc" <?php if((!isset($contact) && total_rows('tblsuppliercontacts',array('email_cc'=>1,'supplierid'=>$supplier_id)) == 0) || (isset($contact) && $contact->email_cc == 1)){echo 'checked';}; ?> >
                            <label for="email_cc">
                        ...
                        <hr />
                        <p class="bold"><?php echo _l('supplier_permissions'); ?></p>
