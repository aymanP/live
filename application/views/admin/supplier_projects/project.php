            ...
            <div class="col-md-7">
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $selected = (isset($project) ? $project->supplierid : '');
                            if($selected == ''){
                                $selected = (isset($supplier_id) ? $supplier_id: '');
                            }
                        ?>
                        <?php $auto_toggle_class = (isset($project) || isset($do_not_auto_toggle) ? '' : 'auto-toggle'); ?>
                        <?php echo render_select('supplierid',$suppliers,array('supplierid',array('company')),'project_supplier',$selected,array(),array(),'',$auto_toggle_class); ?>
                ...
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="checkbox checkbox-primary">
                            ...
                            <label for="<?php echo $setting; ?>"><?php echo _l('project_allow_supplier_to',_l('project_setting_'.$setting)); ?></label>
                        </div>
                        <hr class="no-margin" />
                        <?php } ?>
                    </div>
...
<script>
    $(document).ready(function()
    {
        ...
        _validate_form($('form'),{name:'required',supplierid:'required',contactid:'required',start_date:'required',deadline:'required',billing_type:'required'});
        ...
        $('select[name="supplierid"]').on('change',function()
        {
            ...
            $.get(admin_url + 'supplier_projects/get_contacts_by_supplier/' + supplier_id, function(response)
            {
