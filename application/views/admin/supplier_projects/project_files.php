<?php echo form_open_multipart(admin_url('supplier_projects/upload_file/'.$project->id),array('class'=>'dropzone','id'=>'project-files-upload')); ?>
<input type="file" name="file" multiple />
<?php echo form_close(); ?>
<small class="mtop5"><?php echo _l('project_file_visible_to_supplier'); ?></small><br />
<input type="checkbox" name="visible_to_supplier" class="switch-box input-xs" data-size="mini">
        ...
        <table class="table dt-table" data-order-col="4" data-order-type="desc">
            <thead>
                <tr>
                    ...
                    <th><?php echo _l('project_file_visible_to_supplier'); ?></th>
                ...
                <tr>
                    ...
                    <td>
                        <?php
                            ...
                            ?>
                        <input type="checkbox" class="switch-box input-xs" data-size="mini" data-id="<?php echo $file['id']; ?>" data-switch-url="<?php echo ADMIN_URL; ?>/supplier_projects/change_file_visibility" <?php echo $checked; ?>>
                    </td>
                    <td>
                    ...
                    <td>
                        <button type="button" data-toggle="modal" data-original-file-name="<?php echo $file['file_name']; ?>" data-filetype="<?php echo $file['filetype']; ?>"
                                data-path="<?php echo PROJECT_ATTACHMENTS_FOLDER .$project->id.'/'.$file['file_name']; ?>" data-target="#send_file" class="btn btn-info btn-icon">
                            <i class="fa fa-envelope"></i>
                        </button>
                        <?php if($file['staffid'] == get_staff_user_id() || has_permission('projects','','delete')){ ?>
                        <a href="<?php echo admin_url('supplier_projects/remove_file/'.$project->id.'/'.$file['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
                        <?php } ?>
                    </td>
                </tr>
                <?php } ?>
