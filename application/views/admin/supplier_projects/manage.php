        ...
        <div class="panel_s">
          <div class="panel-body _buttons">
            <?php if(has_permission('projects','','create')){ ?>
              <a href="<?php echo admin_url('supplier_projects/project'); ?>" class="btn btn-info pull-left display-block">
              ...
              <div class="panel-body">
               <div class="row mbot15">
                <div class="col-md-12">
                  ...
                  $_where = '';
                  if(!has_permission('projects','','view')){
                    $_where = 'supplierid != 0 AND id IN (SELECT project_id FROM tblprojectmembers WHERE staff_id='.get_staff_user_id().')';
                  }
                  ?>
                </div>
                <div class="_filters _hidden_inputs">
                  ...
                  foreach($statuses as $status){
                   ...
                   <div class="col-md-2 col-xs-6 border-right">
                    <?php $where = ($_where == '' ? '' : $_where.' AND ').'supplierid != 0 AND status = '.$status; ?>
