            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body _buttons">
                        <div class="row">
                            ...
                            ?>
                             <a href="<?php echo admin_url('supplier_projects/pin_action/'.$project->id); ?>" data-toggle="tooltip" data-title="<?php echo $project_pin_tooltip; ?>" class="btn <?php echo $project_pin_class; ?> btn-with-tooltip"><i class="fa fa-thumb-tack"></i></a>
                                <?php if(has_permission('projects','','edit')){ ?>
                                <a href="<?php echo admin_url('supplier_projects/project/'.$project->id); ?>" data-toggle="tooltip" data-title="<?php echo _l('edit_project'); ?>" class="btn btn-default btn-with-tooltip"><i class="fa fa-pencil-square-o"></i></a>
                                <?php } ?>
                                ...
                                <a href="<?php echo admin_url('supplier_projects/delete/'.$project->id); ?>" data-toggle="tooltip" data-title="<?php echo _l('delete_project'); ?>" class="btn btn-danger btn-with-tooltip _delete"><i class="fa fa-remove"></i></a>
                                <?php } ?>
                                <?php
                ...
                <div class="panel_s">
                    ...
                    <?php do_action('before_render_project_view',$project->id); ?>
                        ...
                        <?php $this->load->view('admin/supplier_projects/project_tabs'); ?>
                    </div>
                </div>
                <div class="panel_s">
                    <div class="panel-body">
...
<?php $this->load->view('admin/supplier_projects/milestone'); ?>
<?php $this->load->view('admin/supplier_projects/timesheet'); ?>
<?php $this->load->view('admin/supplier_projects/copy_settings'); ?>
<?php init_tail(); ?>
