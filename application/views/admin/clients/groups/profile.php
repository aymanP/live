    ...
    <div class="col-md-12">
        ...
        <div class="tab-content">
                        ...
                        <?php if($client->profile_image != NULL){ ?>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <?php echo client_profile_image($_staff->staffid,array('img','img-responsive','client-profile-image-thumb'),'thumb'); ?>
                                    </div>

                                    <div class="col-md-3 text-right">
                                        <a href="<?php echo admin_url('clients/remove_client_profile_image'); ?>"><i class="fa fa-remove"></i></a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
            ...
            <div role="tabpanel" class="tab-pane ptop10" id="contacts">
                ...
                <a href="#" onclick="contact(<?php echo $client->userid; ?>); return false;" class="btn btn-info"><?php echo _l('new_contact'); ?></a>
                <?php } ?>
                <?php
