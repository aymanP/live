        ...
        <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="option form-group">
                ...
                <div class="<?php if(has_permission('settings','','delete')){echo 'input-group';}else{echo 'form-group';} ?>">
                    ...
                    <div class="input-group-addon">
                        <a href="#" onclick="delete_option(this,<?php echo $field['id']; ?>); return false;" class="text-danger"><i class="fa fa-remove"></i></a>
                    </div>
                    <?php } ?>
                </div>
            </div>
