	...
	<div role="tabpanel" class="tab-pane active" id="general">
		<div class="row">
			<div class="col-md-6">
				...
				<hr />
				<i class="fa fa-question-circle" data-toggle="tooltip" data-title="eq. Item TAX 15% will be shown as 15% without the tax name (Not applied if multiple taxes with the same name and tax percent found for item)"></i>
			...
			<div class="col-md-6">
				<h4 class="bold"><?php echo _l('settings_amount_to_words'); ?> (BETA)</h4>
