                        ...
                        <div class="mbot15 row" data-attachment-id="<?php echo $attachment['id']; ?>">
                            ...
                            <div class="col-md-4 text-right">
                                <?php if($attachment['visible_to_customer'] == 0){
                                    ...
                                    ?>
                                <a href="#" data-toggle="tooltip" onclick="toggle_sales_attachment_visibility(<?php echo $attachment['id']; ?>,<?php echo $proposal->id; ?>,this); return false;" data-title="<?php echo $tooltip; ?>"><i class="fa <?php echo $icon; ?>" aria-hidden="true"></i></a>
