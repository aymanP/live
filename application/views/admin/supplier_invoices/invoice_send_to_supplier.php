<div class="modal fade email-template" data-editor-id=".<?php echo 'tinymce-'.$invoice->id; ?>" id="invoice_send_to_client_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <?php echo form_open('admin/supplier_invoices/send_to_email/'.$invoice->id); ?>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <?php
                                ...
                                $primar = $this->supplier_model->get_contact_primary($invoice->supplierid);
                                $contac = $this->supplier_model->get_contact_project($invoice->supplierid);
