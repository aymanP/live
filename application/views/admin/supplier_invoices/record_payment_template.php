...
<div class="col-md-12 no-padding animated fadeIn">
    <div class="panel_s">
        <?php echo form_open('admin/supplier_invoices/record_payment'); ?>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="selectpicker display-block" name="paymentmode" data-width="100%" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                            <option value=""></option>
            ...
            <div class="pull-right mtop15">
                <a href="#" class="btn btn-danger" onclick="init_supplier_invoice(<?php echo $invoice->id; ?>); return false;"><?php echo _l('cancel'); ?></a>
