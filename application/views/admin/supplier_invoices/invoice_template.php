            ...
            <div class="col-md-6 border-right">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php include_once(APPPATH .'views/admin/supplier_invoices/billing_and_shipping_template.php'); ?>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <?php echo render_textarea('adminnote','invoice_add_edit_admin_note',$value); ?>
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="<?php echo admin_url('supplier_invoices/list_invoice/'.$recurring->id); ?>" target="_blank"><?php echo format_invoice_number($recurring->id); ?></a>
                        </li>
                    </ul>
                    <?php } ?>
                    <?php } ?>
    ...
    <div class="row">
        <div class="col-md-12 mtop15">
            <div class="panel-body">
                ...
                <?php echo render_textarea('suppliernote','invoice_add_edit_supplier_note',$value,array(),array(),'mtop15'); ?>
