                ...
                <div class="btn-group pull-right mleft4 invoice-view-buttons btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
                    ...
                    <ul class="dropdown-menu width300">
                        ...
                        <?php foreach($payment_modes as $mode){ ?>
                            <li>
                                <a href="#" data-cview="invoice_payments_by_<?php echo $mode['id']; ?>" onclick="dt_custom_view('<?php echo $mode['id']; ?>//','.table-supplier_invoices','invoice_payments_by_<?php echo $mode['id']; ?>//'); init_supplier_invoices_total(); return false;">
