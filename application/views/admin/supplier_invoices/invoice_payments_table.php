        ...
        <tbody>
            ...
            <tr class="payment">
                ...
                <td>
                    ...
                    <a href="<?php echo admin_url('supplier_invoices/delete_payment/'.$payment['paymentid'] . '/' . $payment['invoiceid']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
