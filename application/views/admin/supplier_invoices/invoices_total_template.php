        ...
        <div class="<?php echo $col; ?> stats-total-currency">
            <div class="panel_s">
                <div class="panel-body">
                    <select class="selectpicker" name="total_currency" onchange="init_supplier_invoices_total();" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
