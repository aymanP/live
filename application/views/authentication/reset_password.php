<?php $this->load->view('authentication/includes/head.php'); ?>
  ...
  <?=form_open($this->uri->uri_string(), $attributes)?>
    ...
    <div class="forgotpass-info"><?php echo _l('admin_auth_reset_password_heading'); ?></h1></div>
    ...
    <input type="submit" class="btn btn-primary" value="<?php echo _l('auth_reset_password_submit'); ?>" />
