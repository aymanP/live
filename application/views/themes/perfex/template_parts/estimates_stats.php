...
if(get_option('exclude_estimate_from_client_area_with_draft_status') == 0){
     $total_estimates = total_rows('tblestimates',array('clientid'=>get_client_user_id()));
} else {
    $total_estimates = total_rows('tblestimates',array('clientid'=>get_client_user_id(),'status !='=>1));
}
