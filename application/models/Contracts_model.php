...
class Contracts_model extends CRM_Model
{
    ...
    public function sent_contract_to_client($id, $attachpdf = true)
    {
            ...
            foreach ($sent_to as $contact_id) {
                    ...
                    if ($this->input->post('email_attachments')) {
                        ...
                        foreach ($_other_attachments as $attachment) {
                            ...
                            $this->emails_model->add_attachment(array(
                                'attachment' => CONTRACTS_UPLOADS_FOLDER . $id . '/' . $_attachment->file_name,
                    ...
                    $merge_fields = array_merge($merge_fields, get_contract_merge_fields($id));
                    if ($this->emails_model->send_email_template('send-contract', $contact->email, $merge_fields)) {
                        $send = true;
                    }
                }
            }
