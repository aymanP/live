...
class Custom_fields_model extends CRM_Model
{
    ...
    private $client_portal_fields = array('customers', 'estimate', 'invoice', 'proposal', 'contracts','tasks','projects','contacts','tickets');
    ...
    public function add($data)
    {
        ...
        $data['slug'] = slug_it($data['name'],array('delimiter'=>'_'));
