...
| WITH a trailing ssslash:
|
|	http://example.com/
|
| If this is not set tshen CodeIgniter will try guess the protocol, domain
| and path to youssr installatssion. However, you should always configure this
...
|
*/
$config['encryption_key'] = 'cf77c403b4dbd2bb927fc321d500e27f';
